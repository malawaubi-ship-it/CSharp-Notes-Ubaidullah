...
        Console.WriteLine( "Is the stack empty? " + (stack.Count == 0 ? "Yes" : "No")); // Output: No
 
...
        Console.WriteLine( "Is the stack empty now? " + (stack.Count == 0 ? "Yes" : "No")); // Output: Yes
    }
}
Output:
...
            Console.WriteLine( $"Redo: {lastUndoneAction}");
        } else {
...
        Console.WriteLine( $"Is the expression '{expression}' balanced? {IsBalanced(expression)}");
    }
}
Expected Output:
...
 
        Console.WriteLine( $"Is the expression '{expression1}' balanced? {validator.IsBalanced(expression1)}");
        Console.WriteLine( $"Is the expression '{expression2}' balanced? {validator.IsBalanced(expression2)}");
        Console.WriteLine( $"Is the expression '{expression3}' balanced? {validator.IsBalanced(expression3)}");
    }
}
Expected Output:
